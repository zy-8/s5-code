...
contract Bank is IBank {
    ...
    //从合约取款
    function withdraw(uint256 value) public virtual override {
        //判断调用者是指定的管理员
    ...
    // 获取前三名存款用户
    function getTopUsers() public view override returns (IBank.User[3] memory) {
        return topUser;
    }
}
